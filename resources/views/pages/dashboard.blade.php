        ...
        <section class="section">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            Total Customer : {{ $data['total_customers'] }}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            Total Teknisi : {{ $data['total_technicians'] }}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            Pending Payment : {{ $data['pending_payments'] }}
                        </div>
                    </div>
                </div>
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('assets/library/simpleweather/jquery.simpleWeather.min.js') }}"></script>
