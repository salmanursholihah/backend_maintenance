...
@push('style')
    <!-- CSS Libraries -->
<<<<<<< HEAD:resources/views/pages/template/bootstrap-typography.blade.php
...
>>>>>>> 524fbaa5e5e1e1a8ae05a0ba09c0756db7937190:resources/views/pages/bootstrap-typography.blade.php
@endpush
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="lead mt-4">
                                    Lead &mdash; Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Duis
                                    mollis, est non commodo luctus.
                                </p>
                                <p class="mt-4 mb-4">Paragraph &mdash; Lorem ipsum dolor sit amet, consectetur adipisicing
                                    elit, sed do eiusmod
